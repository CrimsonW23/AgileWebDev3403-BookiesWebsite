...
Revision ID: 10a45173b0d4
Revises: 476d7e8fd3a5
Create Date: 2025-05-16 09:16:51.678176
...
def upgrade():
    ...
    with op.batch_alter_table('reply', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_reply_author_id_user', 'user', ['author_id'], ['id'])
        batch_op.drop_column('author')
